...
@section('content')
    <div class="row">
        <div class="col-md-12 md-margin-bottom-40">
            <div class="headline"><h2>People</h2>
                <div class="results-number pull-right">{{ $count }} People Found</div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-3 md-margin-bottom-40">
            <ul class="list-group sidebar-nav-v1 margin-bottom-40" id="sidebar-nav-1">
                ...
                <li class="list-group-item">
                    <a href="page_profile_projects.html"><i class="fa fa-map-marker"></i> Places</a>
                </li>
                <li class="list-group-item">
